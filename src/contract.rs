...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        ...
        HandleMsg::WithdrawVotingTokens { amount } => withdraw_voting_tokens(deps, env, info, amount),
        HandleMsg::CastVote {
            poll_id,
            vote,
            weight,
...
pub fn create_poll<S: Storage, A: Api, Q: Querier>(
    ...
    let r = HandleResponse {
        messages: vec![],
        attributes : vec![
            Attribute { key:"action".to_string(), value:"create_poll".to_string(), },
            Attribute { key: "creator".to_string(), value: deps.api.human_address(&new_poll.creator)?.to_string(), },
            Attribute { key: "poll_id".to_string(), value: poll_id.to_string(), },
            Attribute { key: "quorum_percentage".to_string(), value: quorum_percentage.unwrap_or(0).to_string(), },
            Attribute { key: "end_height".to_string(), value: new_poll.end_height.to_string(), },
...
pub fn end_poll<S: Storage, A: Api, Q: Querier>(
    ...
    let attributes = vec![
        Attribute { key: "action".to_string(), value: "end_poll".to_string(), },
        Attribute { key: "poll_id".to_string(), value: poll_id.to_string(), },
...
fn query_poll<S: Storage, A: Api, Q: Querier>(
    ...
    let key = &poll_id.to_string();
//poll_readはstateにて定義、バイナリをオブジェクト化
